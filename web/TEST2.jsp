<%-- 
    Document   : TEST2
    Created on : 1 déc. 2019, 23:37:19
    Author     : TOSHIBA
--%>

<<%-- 
    Document   : ObjetAbonne
    Created on : 2 déc. 2019, 08:00:29
    Author     : TOSHIBA
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <a href="accueilAdmin.jsp"> <figure><img src="img/shutdown.png" alt="image" style="max-height: 50px;max-width: 50px"><figcaption style="font-size: 16px;font-family: Arial Black;color:#000">Retour</figcaption></figure></a>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </nav>
  ...
  <!-- 	<div class="banner-area banner-bg-1">
    ...
    <div id="about" class="section wb">
	  ...
	  <div class="section-title text-center">
                <h3>Mes Objets</h3>
                <p class="lead">Vous pouver manipuler les objets</p>
            </div><!-- end title -->
...
<!--                        <div class="price-value">
                            <div class="value">
                              <span class="currency"> </span>
                                <span class="amount">${ob.connectivite}<span></span></span>
                                
                                <span class="month">Connectivite</span>
                            </div>
                           <div class="value">
                              <span class="currency"> </span>
                       <span class="year">Connectivite<br>${ob.connectivite}</span>
                           </div></div>-->
<a>
