...
<nav class="navbar navbar-light bg-light" style="size: 40px; align-content: center; ">
  <form class="form-inline" class="form-horizontal" action="Controleur" methode="POST">
                    <input type="hidden" name="action" value="RchZone"/>
                    <div class="form-row">
                        <table align="center">
                            <tbody>
                                <tr>
                                    <td><input class="form-control mr-sm-2" type="text" placeholder="---Taper votre recherche---" aria-label="Search" type="hidden" name="rechZone" style="width:230px"/></td>
...
<table class="table table-hover">
  <thead>
    <tr style="text-align: center; font-size:30px; background-color: #FFA500" >
      ...
      <th  scope="col" style="text-align: center; font-size:20px; Time new Roman;color: black">Identifiant Zone</th>
  ...
  <tbody>
    ...
    <tr style="text-align: center; font-size:20px;">
      ...
      <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${zo.idZone}</th>
      <th scope="col" style="text-align: center; font-size:17px; font-family: Time new Roman;color: black">${zo.nomZone}</th>
     

      <th style="text-align: center;"><a href='Controleur?action=supprimerZone&idZone=${zo.idZone}'><!--<button type="button" class="btn btn-danger">--><img src="img/del.png" style="width: 25px"/></button></a></th>
       <th style="text-align: center;"> <a href='Controleur?action=modifierZone&idZone=${zo.idZone}'><!--<button type="button" class="btn btn-success">--><img src="img/pen.png" style="width: 25px"/></button></a></th>
