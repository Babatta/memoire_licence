<%-- 
    Document   : modifierObjet
    Created on : 6 déc. 2019, 16:13:40
    Author     : TOSHIBA
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a  href="Controleur?action=rtrOb" style="font-size: 140%">retour</a></li>
                        </ul>   
                    </div>
                </div>
                <br/>
        ...
        <div class="container-login100" style="background-image: url('images/lampe.png');">
            <div class="wrap-login100 p-l-100 p-r-100 p-t-200 p-b-30" style="background-image: url('images/bg.png'); background-color: #faf9f8; width: 1000px;"> 
                ...
                <form class="login100-form validate-form" method="POST" action="Controleur" style="font-size:20px;">
                    <input type="hidden" name="action" value="updateObjet"/>
                    ...
                    <div class="form-group">
                        <label for="inputAddress2"><h5><a style="font-size:24px; ">Nom Objet</a></h5></label>
                        <input type="text" class="form-control" id="inputAddress2" style="font-size:24px; max-width: 1200px;" name="nomObjet" value="${Objet.nomObjet}" required>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="inputAddress2"><h5><a style="font-size:24px; max-width: 1200px;">Type</a></h5></label>
                            <input type="text" class="form-control"  style="font-size:24px; max-width: 1200px;" id="inputAddress2" name="type" value="${Objet.type}"  required>
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2"><h5><a style="font-size:24px;">Connectivite</a></h5></label>
                            <input type="text" class="form-control"  style="font-size:24px; max-width: 1200px;" id="inputAddress2" name="connectivite"  value="${Objet.connectivite}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputCity"><h5><a style="font-size:24px;">Voltage</a></h5></label>
                        <input type="text" class="form-control"  style="font-size:24px; max-width: 1200px;" id="inputCity"  name="voltage"  value="${Objet.voltage}"  required>
                    </div>
