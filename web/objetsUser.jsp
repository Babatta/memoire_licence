<%-- 
    Document   : objetsUser
    Created on : 9 déc. 2019, 14:24:40
    Author     : TOSHIBA
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a  href="Controleur?action=listeAbonne" style="font-size: 140%">retour</a></li>
                        </ul>
                    </div>
                </div>
                <br/>
...
<br/>         <div class="container">          
                    ...
                    <span class="login100-form-title p-b-37" id="cal" >
                        <p style="text-align: center; font-size:30px; Time new Roman;color: black;  font-size:30px;"> Objets de l'abonné:${User.nom} ${User.prenom} </p>
                    </span> 

                    <div class="container" style="text-align: center; font-size:15px;">


                        <c:if test="${!empty listeObjetUser && !vu}">
                              ...
                              <thead>--><div class="container">
                                <div class="col-lg-12">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach var="ob" items="${listeObjetUser}">
