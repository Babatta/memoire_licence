<%-- 
    Document   : listeReseau
    Created on : 5 déc. 2019, 09:21:59
    Author     : TOSHIBA
--%>
        ...
        <div class="container">          
            <nav class="navbar navbar-light bg-light" style="size: 40px; align-content: center; ">
                <form class="form-inline" class="form-horizontal" action="Controleur" methode="POST">
                    <input type="hidden" name="action" value="RchReseau"/>
                    <div class="form-row">
                        <table align="center">
                            <tbody>
                                <tr>
                                    <td><input class="form-control mr-sm-2" type="text" placeholder="---Taper votre recherche---" aria-label="Search" type="hidden" name="rechReseau" style="width:230px"/></td>
            ...
            <div class="container" style="text-align: center; font-size:15px;">
                <c:if test="${!empty listerReseau && !vu}">
                    <div class="container" style="text-align: center; font-size:15px;">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr style="text-align: center; font-size:30px; background-color: #FFA500" >
                                    ...
                                    <th  scope="col"  style="text-align: center; font-size:20px; Time new Roman;color: black;">Identifiant Reseau</th>
                            ...
                            <tbody>
                                <c:forEach var="re" items="${listerReseau}"> 
                                    <tr style="text-align: center; font-size:20px;">
                                        ...
                                        <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black;">${re.idReseau}</th>
                                        <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black;">${re.nomReseau}</th>


                                        <th style="text-align: center;"><a href='Controleur?action=supprimerReseau&idReseau=${re.idReseau}'><button type="button" class="btn btn-danger">Supprimer</button></a>
                                            <a href='Controleur?action=modifierReseau&idReseau=${re.idReseau}'><button type="button" class="btn btn-success"><img src="img/pen.png" style="width: 25px"/></button></a></th>
