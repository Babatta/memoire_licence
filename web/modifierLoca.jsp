<%-- 
    Document   : modifierLoca
    Created on : 8 déc. 2019, 00:04:18
    Author     : TOSHIBA
--%>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a  href="Controleur?action=rtrLoca" style="font-size: 140%">Retour</a></li>
                    </ul>
                </div>
            </div>
        <br/>
            ...
            <div class="wrap-login100 p-l-100 p-r-100 p-t-200 p-b-30" style="background-image: url('images/bg.png'); background-color: #faf9f8; width: 1000px;"> 
                <div class="top-bar">
                    ...
                    <form class="login100-form validate-form" method="POST" action="Controleur">
                        ...
                        <input type="hidden" name="idLoca" value="${Localisation.idLocalisation}"/>
                       <input type="hidden" name="idBat" value="${Localisation.idBatiment}"/>
                       <input type="hidden" name="idZone" value="${Localisation.idZone}"/>
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="inputAddress2" style="font-size:20px;"  type="text"  name="nomLoca"   value="${Localisation.nomLocalisation}" required>
                                </div></div>
                        <div class="form-group">
                            <label for="inputAddress2"><h5><a style="font-size:20px;">Type Localisation</a></h5></label>
                            <input type="text" class="form-control" style="font-size:20px;" id="inputAddress2" type="text"  name="typeLoca" value="${Localisation.typeLocalisation}" required>
                        </div><br>

                        <div class="container-login100-form-btn">
                            <input type="submit" value="Enregistrer" style="font-size:20px;max-width: 75px" class="login100-form-btn" style="max-width: 50px"/><br/><br/>
                        </div>
                    </form>
            </div>
        </div>
