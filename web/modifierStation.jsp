<%-- 
    Document   : modifierStation
    Created on : 8 déc. 2019, 15:57:01
    Author     : TOSHIBA
--%>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a  href="Controleur?action=rtrSta" style="font-size: 140%">Retour</a></li>
                    </ul>
                </div>
            </div>
        <br/>
        ...
        <div class="container-login100" style="background-image: url('images/lampe.png'); background-attachment: fixed;">
            ...
            <form class="login100-form validate-form" method="POST" action="Controleur">
                ...
                <input type="hidden" name="action" value="updateSta"/> 
                 <input type="hidden" name="idSta" value="${Station.idStation}"/>
                 <input type="hidden" name="idReseau" value="${Station.idReseau}"/>
               <span class="login100-form-title p-b-37" id="cal">
                           Modification Station:
                        </span> 
            
                        <div class="form-group">
                            <label for="inputAddress2"><h5><a style="font-size:24px; ">Nom Station</a></h5></label>
                    <input class="form-control"  id="inputAddress2" style="font-size:24px; " type="text" name="nomStation"  value="${Station.nomStation}"  required>
                    </div>
                        
                <div class="form-group">
                    <label for="inputAddress2"><h5><a style="font-size:24px; ">Type Station</a></h5></label>
                    <input  class="form-control" type="text" style="font-size:24px; " name="typeStation"  id="inputAddress2"  value="${Station.typeStation}"  required>
                    
                </div>
                   <div class="form-group">
                 <label for="inputAddress2"><h5><a style="font-size:24px; ">Connectivite</a></h5></label>
                    <input  class="form-control"  style="font-size:24px; " type="text" id="inputAddress2" name="connectivite"   value="${Station.connectiviteStation}" required>
                   
                </div>
                        <div class="form-group">
                    <label for="inputAddress2"><h5><a style="font-size:24px; ">Alerte</a></h5></label>
                    <input  class="form-control" type="text"  style="font-size:24px; " id="inputAddress2" name="alerte"    value="${Station.alerte}"    required>
