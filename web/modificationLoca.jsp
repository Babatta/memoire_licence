<%-- 
    Document   : modificationLoca
    Created on : 7 déc. 2019, 22:10:22
    Author     : TOSHIBA
--%>
            ...
            <div class="wrap-login100 p-l-100 p-r-100 p-t-200 p-b-30" style="background-image: url('images/bg.png'); background-color: #faf9f8; width: 1000px;"> 
                <div class="top-bar">
                    ...
                    <form class="login100-form validate-form" method="POST" action="Controleur" >
                        <input type="hidden" name="action" value="updateLoca"/>
                         <input type="hidden" name="idLoca" value="${Localisation.idLoca}"/>
                          <input type="hidden" name="idBat" value="${Localisation.idBat}"/>
                           <input type="hidden" name="idZone" value="${Localisation.idZone}"/>
                        ...
                        <div class="form-row"  >
                            ...
                            <label for="inputAddress2"><h5><a style="font-size:30px;" >Nom Localisation</a></h5></label>
                            <input type="text" class="form-control" id="inputAddress2" style="font-size:30px;"  type="text"  name="nomLocalisation" value="${Localisation.nomLocalisation}" required>
                                </div></div>
                        <div class="form-group" style="font-size:20px;" >
                            <label for="inputAddress2"><h5><a style="font-size:24px;"  >Type Localisation</a></h5></label>
                            <input type="text" class="form-control" style="font-size:30px;" id="inputAddress2" type="text" name="typeLocalisation" value=         
                                   <input type="text" class="form-control" style="font-size:30px;" id="inputAddress2" type="text" name="typeLocalisation" value="${Localisation.typeLocalisation}" required> required>
                        </div><br>

                        <div class="container-login100-form-btn">
                            <input type="submit" value="Enregistrer" style="font-size:30px;max-width: 75px" class="login100-form-btn"/><br/><br/>
                        </div>
                    </form>
            </div>
        </div>
