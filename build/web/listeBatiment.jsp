        ...
        <div class="container">          
            ...
            <nav class="navbar navbar-light bg-light" style="size: 40px; align-content: center; ">
                <form class="form-inline" class="form-horizontal" action="Controleur" methode="POST">
                    <input type="hidden" name="action" value="RchBat"/>
                    <div class="form-row">
                        <table align="center">
                            <tbody>
                                <tr>
                                    <td><input class="form-control mr-sm-2" type="text" placeholder="---Taper votre recherche---" aria-label="Search" type="hidden" name="rechBat" style="width: 230px"/></td>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr style="text-align: center; font-size:30px; background-color: #FFA500" >
                                ...
                                <th  scope="col"  style="text-align: center; font-size:20px; Time new Roman;color: black;">Identifiant Batiment</th>
                                <th  scope="col"  style="text-align: center; font-size:20px; Time new Roman;color: black;">Zone Batiment</th>
                                <th scope="col"  style="text-align: center; font-size:20px; Time new Roman;color: black;">Nom Batiment</th>

                                <th  scope="col" classe="floatright"  style="text-align: center; font-size:20px; Time new Roman;color: black;">Actions</th>
                        ...
                        <tbody>
                            <c:forEach var="bat" items="${listerBatiment}"> 
                                <tr style="text-align: center; font-size:20px;">
                                    ...
                                    <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${bat.idBatiment}</th>
                                    <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${bat.nomZone}</th>
                                    <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${bat.nomBatiment}</th>

                                    <th style="text-align: center;"><a href='Controleur?action=supprimerBat&idBat=${bat.idBatiment}&idZone=${bat.idZone}'><button type="button" class="btn btn-danger">Supprimer</button></a>
                                        <a href='Controleur?action=modifierBat&idBat=${bat.idBatiment}&idZone=${bat.idZone}'><button type="button" class="btn btn-success"><img src="img/pen.png" style="width: 25px"/></button></a></th>
