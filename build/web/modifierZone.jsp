<%-- 
    Document   : modifierZone
    Created on : 7 déc. 2019, 17:38:04
    Author     : TOSHIBA
--%>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a  href="Controleur?action=rtrZ" style="font-size: 140%">retour</a></li>
                        </ul>  
                    </div>
                </div>
                <br/>
        ...
        <div class="container-login100" style="background-image: url('images/lampe.png');">
            <div class="wrap-login100 p-l-100 p-r-100 p-t-200 p-b-30" style="background-image: url('images/bg.png'); background-color: #faf9f8; width: 1000px;"> 
                ...
                <form class="login100-form validate-form" method="POST" action="Controleur"  style='size: 70px;'>
                    ...
                    <div class="for-group">
                        <label for="inputAddress2"><h5><a  style="font-size:24px;" >Nom Zone</a></h5></label>
                        <input  class="form-control" id="inputAddress2" type="text" style="font-size:24px;" name="nomZone" value='${Zone.nomZone}'  required>
