<%-- 
    Document   : modifierBatiment
    Created on : 7 déc. 2019, 20:38:54
    Author     : TOSHIBA
--%>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a  href="Controleur?action=rtrBat" style="font-size: 140%">Retour</a></li>
                        </ul>
                    </div>
                </div>
                <br/>
        ...
        <div class="container-login100" style="background-image: url('images/lampe.png'); background-attachment: fixed;">
            <div class="wrap-login100 p-l-100 p-r-100 p-t-200 p-b-30" style="background-image: url('images/bg.png'); background-color: #faf9f8; width: 1000px;"> 
                <div class="top-bar">
                ...
                </div> <form class="login100-form validate-form" method="POST" action="Controleur" style='size: 70px;'>

                    <input type="hidden" name="action" value="updateBat"/>
                    <input type="hidden" name="idBat" value="${Batiment.idBatiment}"/>
                    <input type="hidden" name="idZone" value="${Batiment.idZone}"/>
                    ...
                    <div class="form-group">
                        <label for="inputAddress2"><h5><a  style="font-size:20px;"  >Nom Batiment</a></h5></label>
                        <input type="text" class="form-control"  style="font-size:20px;"  id="inputAddress2" type="text" placeholder="nom batiment" name="nomBat" value="${Batiment.nomBatiment}" required>
                    </div>

                    <div class="container-login100-form-btn">
                        <input type="submit" value="Enregistrer" class="login100-form-btn"   style="font-size:20px;max-width: 50px"><br/><br/>
                    </div>
                </form>
            </div>
