    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light" style="size: 40px; align-content: center; ">
            <form class="form-inline" class="form-horizontal" action="Controleur" methode="POST">
                <input type="hidden" name="action" value="RchLoca"/>
                <div class="form-row">
                    <table align="center">
                        <tbody>
                            <tr>
                                <td><input class="form-control mr-sm-2" type="text" placeholder="---Taper votre recherche---" aria-label="Search" type="hidden" name="rechLoca" style="width:230px"/></td>
            ...
            <table class="table table-hover">
                <thead>
                    <tr style="text-align: center; font-size:30px; background-color: #FFA500" >
                        ...
                        <th  scope="col" style="text-align: center; font-size:20px; Time new Roman;color: black">Identifiant Localisation</th>
                        ...
                        <th scope="col" style="text-align: center; font-size:20px; Time new Roman;color: black">Supprimer</th>
                ...
                <tbody>
                    <c:forEach var="l" items="${listeLoca}"> 
                        <tr style="text-align: center; font-size:20px;">
                            ...
                            <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${l.idLocalisation}</th>
                            <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${l.nomZone}</th>
                            <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${l.nomBatiment}</th>
                            <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${l.nomLocalisation}</th>
                            <th scope="col" style="text-align: center; font-size:17px; Time new Roman;color: black">${l.typeLocalisation}</th>

                            <th style="text-align: center;"><a href='Controleur?action=supprimerLoca&idloca=${l.idLocalisation}&idBat=${l.idBatiment}&idZone=${l.idZone}'><button type="button" class="btn btn-danger">Supprimer</button></a>
                            <th style="text-align: center;"> <a href='Controleur?action=modifierLoca&idLoca=${l.idLocalisation}&idBat=${l.idBatiment}&idZone=${l.idZone}'><button type="button" class="btn btn-success"><img src="img/pen.png" style="width: 25px"/></button></a></th>
